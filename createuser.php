...
require_once apm_BASE_DIR . '/lib/captcha/Functions.php';
require_once apm_BASE_DIR . '/style/' . $uistyle . '/overrides.php';
...
<script type="text/javascript"
	src="<?php echo apm_BASE_URL; ?>/js/passwordstrength.js"></script>
<script language="javascript">
function submitIt(){
    var form = document.editFrm;
   if (form.user_username.value.length < <?php echo apmgetConfig('username_min_len'); ?>) {
        alert("<?php echo $AppUI->_('Username size is invalid, should be greater than', UI_OUTPUT_JS); ?>" + ' ' + <?php echo apmgetConfig('username_min_len'); ?>);
        form.user_username.focus();
    } else if (form.user_password.value.length < <?php echo apmgetConfig('password_min_len'); ?>) {
        alert("<?php echo $AppUI->_('Password size is invalid, should be greater than', UI_OUTPUT_JS); ?>" + ' ' + <?php echo apmgetConfig('password_min_len'); ?>);
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
		<td width="508"><a href="http://www.softmag.eu"><img border="0"
				alt="apmProject Home"
				src="./style/<?php echo $uistyle; ?>/images/apm_logo.png" /></a></td>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
		<td valign="top" style="background: url(./style/<?php echo $uistyle; ?>/images/nav_shadow.jpg)" align="left">
			...
			src="./style/<?php echo $uistyle; ?>/images/nav_shadow.jpg" alt="" />
		</td>
	</tr>
</table>
...
<table align="center" border="0" width="700" cellpadding="0"
	cellspacing="0" class="">
	<tr>
		<td style="padding-top: 10px; padding-bottom: 10px;" align="left"
			valign="top" class="txt"><h1>New Signup to apmProject!</h1> Please
			enter the info below to create a new signup.</td>
	</tr>
</table>
<?php
...
<form name="editFrm" action="./do_user_aed.php" method="post"
	...
	<input type="hidden" name="user_id" value="0" /> <input type="hidden"
		name="contact_id" value="0" /> <input type="hidden"
		name="username_min_len"
		value="<?php echo apmgetConfig('username_min_len'); ?>)" /> <input
		type="hidden" name="password_min_len"
		value="<?php echo apmgetConfig('password_min_len'); ?>)" /> <input
		type="hidden" name="cid" value="<?php echo $cid ?>" />
    <?php echo $form->addNonce(); ?>

    <table style="border-style: none;" align="center" border="0"
		width="700" cellpadding="0" cellspacing="0" class="std">
		<tr>
			<td colspan="5"></td>
		</tr>
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				name="user_username" value="" maxlength="255" size="40" /></td>
			<td class="right-brdr"><img
				src="./style/<?php echo $uistyle; ?>/images/shim.gif" width="1"
				height="1" /></td>
		</tr>
		<tr>
			<td align="right">* <?php echo $AppUI->_('Password'); ?>:</td>
			<td colspan="2"><input type="password" class="form-control"
				name="user_password" value="" maxlength="32" size="32"
				onKeyUp="checkPassword(this.value);" /></td>
		</tr>
		<tr>
			<td align="right">* <?php echo $AppUI->_('Confirm Password'); ?>:</td>
			<td colspan="2"><input type="password" class="form-control"
				name="password_check" value="" maxlength="32" size="32" /></td>
		</tr>
		<tr>
			...
			<td>
				<div class="form-control" style="width: 135px;">
					<div id="progressBar"
						style="font-size: 1px; height: 15px; width: 0px;"></div>
				</div>
			</td>
		</tr>
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				name="contact_first_name" value="" maxlength="25" /> <input
				type="text" class="form-control" name="contact_last_name" value=""
				maxlength="25" /></td>
		</tr>
		<tr>
			<td align="right">* <?php echo $AppUI->_('Email'); ?>:</td>
			<td colspan="2"><input type="text" class="form-control"
				name="contact_email" value="" maxlength="255" size="40" /></td>
		</tr>
		<tr>
			<td align="right"><?php echo $AppUI->_('Phone'); ?>:</td>
			<td colspan="2"><input type="text" class="form-control"
				name="contact_phone" value="" maxlength="50" size="40" /></td>
		</tr>
		<tr>
			<td align="right"><?php echo $AppUI->_('Address'); ?>1:</td>
			<td colspan="2"><input type="text" class="form-control"
				name="contact_address1" value="" maxlength="50" size="40" /></td>
		</tr>
		<tr>
			<td align="right"><?php echo $AppUI->_('Address'); ?>2:</td>
			<td colspan="2"><input type="text" class="form-control"
				name="contact_address2" value="" maxlength="50" size="40" /></td>
		</tr>
		<tr>
			<td align="right"><?php echo $AppUI->_('City'); ?>:</td>
			<td colspan="2"><input type="text" class="form-control"
				name="contact_city" value="" maxlength="50" size="40" /></td>
		</tr>
		<tr>
			<td align="right"><?php echo $AppUI->_('State'); ?>:</td>
			<td colspan="2"><input type="text" class="form-control"
				name="contact_state" value="" maxlength="50" size="40" /></td>
		</tr>
		<tr>
			<td align="right"><?php echo $AppUI->_('Postcode') . ' / ' . $AppUI->_('Zip Code'); ?>:</td>
			<td colspan="2"><input type="text" class="form-control"
				name="contact_zip" value="" maxlength="50" size="40" /></td>
		</tr>
		<tr>
			...
			<td colspan="2">
                <?php
																...
																echo arraySelect ( $countries, 'contact_country', 'size="1" class="form-control"', 0 );
																?>
			</td>
		</tr>
		<tr>
			<td valign="middle" align="right">* <?php echo $AppUI->_('Anti Spam Security'); ?>:</td>
			<td valign="middle" width="50"><input type="text"
				class="form-control" id="spam" name="spam_check" value=""
				maxlength="5" size="5" /></td>
			<td valign="middle" align="left"><img
				src="<?php echo apm_BASE_URL; ?>/lib/captcha/CaptchaImage.php?uid=54;<?php echo $uid; ?>"
				alt="" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="left">&nbsp;<input type="button"
				value="<?php echo $AppUI->_('cancel'); ?>" onclick="history.go(-1)"
				class="btn btn-default" />
			</td>
			<td colspan="2" align="right"><input type="button"
				value="<?php echo $AppUI->_('sign me up!'); ?>" onclick="submitIt()"
