...
?>
<form name="editFrm" action="?m=<?php echo $m; ?>&submod=template" method="post" accept-charset="utf-8" class="addedit invoices">
					...
					<table cellspacing="1" cellpadding="2" border="0" width="100%"
						...
						<tbody>
            				...
            				<tr>
								...
								<td>
                				<?php $form->showField('template_category', $object->template_category, array(), $invoiceTemplateCategory); ?>
            					</td>
							</tr>
