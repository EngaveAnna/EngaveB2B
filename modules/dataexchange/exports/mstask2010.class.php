...
class MSTask2010 extends MSTask2007 {
	public function dump() {
		$taskproperties = array (
				...
				'Priority' => max($this->task ['task_priority'],0),
				...
				'StatusManager' => html_entity_decode ( $this->task ['task_owner_contact'], ENT_QUOTES, "UTF-8" ),
		...
		if ($this->task ['task_represents_project'] > 0) {
			...
			$taskproperties ['Project xmlns="http://schemas.microsoft.com/project/2010"'] = $exporter->exportProject ( $this->task ['task_represents_project'] );
		}
