...
$module = apmgetParam ( $_POST, 'module', 0 );
$lang = apmgetParam ( $_POST, 'lang', $AppUI->user_locale );
$trans = apmgetParam ( $_POST, 'trans', array () );
...
$core_filename = apm_BASE_DIR . '/locales/' . $lang . '/' . $module . '.inc';
if (file_exists ( $core_filename )) {
	$filename = $core_filename;
} else {
	$mod_locale = apm_BASE_DIR . '/modules/' . $module . '/locales';
