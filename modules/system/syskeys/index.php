...
$sysval_id = isset ( $_GET ['sysval_id'] ) ? apmgetParam ( $_GET, 'sysval_id', '' ) : '';

$titleBlock = new apm_Theme_TitleBlock ( 'System Lookup Values', 'myevo-weather.png', $m );
...
<form name="sysValFrm" method="post" action="?m=system&u=syskeys"
	accept-charset="utf-8">
	<input type="hidden" name="del" value="0" /> <input type="hidden"
		name="dosql" value="do_sysval_aed" />
