...
$post = array (
		'sysval_title' => apmgetParam ( $_POST, 'sysval_title' ),
		'sysval_key_id' => apmgetParam ( $_POST, 'sysval_key_id' ),
		'sysval_value' => apmgetParam ( $_POST, 'sysval_value' ) 
);
$svid = array (
		'sysval_title' => apmgetParam ( $_POST, 'sysval_id' ) 
);
