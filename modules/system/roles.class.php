 ...
 * from their user id, but maps it between the apm database and the phpGacl database.
 *
 ...
 */
class CSystem_Role extends apm_Core_BaseObject {
	public $role_id = null;
	 ...
	 *
	 * @param integer $copy_role_id
	 *        	of the Role we are copying permissions from
	 * @param integer $role_id
	 *        	of the Role we are copying permissions to
