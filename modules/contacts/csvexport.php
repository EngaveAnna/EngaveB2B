...
$custom_fields = apm_Core_CustomFields::getCustomFieldList ( 'contacts' );
...
foreach ( $contactList as $contact ) {
	...
	if ($contact ['contact_type'] != '') {
		$categories = "apmProject; " . $contact ['contact_type'];
	} else {
		$categories = "apmProject;";
	}
	...
	$custom_fields = apm_Core_CustomFields::getCustomFieldByModule ( $AppUI, 'contacts', $contact ['contact_id'] );
...
header ( 'Content-Disposition: attachment; filename="' . $apmconfig ['company_name'] . 'Contacts.csv"' );
print_r ( $text );