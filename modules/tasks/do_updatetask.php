...
$notify_owner = apmgetParam ( $_POST, 'task_log_notify_owner', 'off' );
...
if ($result) {
	...
	$email_assignees = apmgetParam ( $_POST, 'email_assignees', null );
	$email_task_contacts = apmgetParam ( $_POST, 'email_task_contacts', null );
	$email_project_contacts = apmgetParam ( $_POST, 'email_project_contacts', null );
	$email_others = apmgetParam ( $_POST, 'email_others', '' );
	$email_log_user = apmgetParam ( $_POST, 'email_log_user', '' );
	$task_log_creator = ( int ) apmgetParam ( $_POST, 'task_log_creator', 0 );
	$email_extras = apmgetParam ( $_POST, 'email_extras', null );
