...
global $task_parent_options, $apmconfig, $projects, $task_project, $can_edit_time_information, $tab;
global $form;

$task_access = array (
		CTask::ACCESS_PUBLIC => 'Public',
		CTask::ACCESS_PROTECTED => 'Protected',
		CTask::ACCESS_PARTICIPANT => 'Participant',
...
<script language="javascript" type="text/javascript">
	subForm.push(new FormDefinition(<?php echo $tab; ?>, document.editFrm, checkDetail, saveDetail));
</script>
