...
$task_id = ( int ) apmgetParam ( $_POST, 'task_id', 0 );
$hassign = apmgetParam ( $_POST, 'hassign' );
$hperc_assign = apmgetParam ( $_POST, 'hperc_assign' );
$hdependencies = apmgetParam ( $_POST, 'hdependencies', '' );
$notify = ( int ) apmgetParam ( $_POST, 'task_notify', 0 );
$_POST ['task_notify'] = $notify;
$allow_other = ( int ) apmgetParam ( $_POST, 'task_allow_other_user_tasklogs', 0 );
$_POST ['task_allow_other_user_tasklogs'] = $allow_other;
$comment = apmgetParam ( $_POST, 'email_comment', '' );
$new_task_project = ( int ) apmgetParam ( $_POST, 'new_task_project', 0 );
...
if ($obj->task_dynamic != 1) {
	$task_dynamic_delay = apmgetParam ( $_POST, 'task_dynamic_nodelay', '0' );
...
$obj->task_departments = implode ( ',', apmgetParam ( $_POST, 'dept_ids', array () ) );
