...
$rm = ( int ) apmgetParam ( $_POST, 'rm', 0 );
$store = ( int ) apmgetParam ( $_POST, 'store', 0 );
$chUTP = ( int ) apmgetParam ( $_POST, 'chUTP', 0 );
$percentage_assignment = ( int ) apmgetParam ( $_POST, 'percentage_assignment', 0 );
$user_task_priority = ( int ) apmgetParam ( $_POST, 'user_task_priority', 0 );
