...
$colors = apmgetSysVal ( 'ProjectColors' );
if ($apmconfig ['restrict_color_selection']) {
	?>
<table class="std">
	<tr>
		<td valign="top" colspan="2"><strong><?php echo $AppUI->_('Color Selector'); ?></strong>
		</td>
	</tr>
        <?php
...
echo $value?>; border: 1px solid black;cursor: pointer;" width="30" onclick="setClose('<?php echo $value ?>')">&nbsp;</td>
...
<table class="std">
	<tr>
		<td valign="top"><strong><?php echo $AppUI->_('Color Selector'); ?></strong>
		</td>
		<form>
			<td align="right" valign="bottom"><select name=""
				class="form-control"
				onchange="javascript:setClose(this.options[this.selectedIndex].value)">
	...
	<tr>
		<td colspan="2"><a href="webpal.map"> <img
				src="<?php echo apmfindImage('colorchart.gif'); ?>" width="292"
				height="196" border="0" alt="color chart" usemap="#map_webpal" ismap />
		</a></td>
	</tr>
	<tr>
		<td colspan="2" align="left"><font size="1"
			face="trebuchetms,verdana,arial">
                <?php echo $AppUI->_('colorLegend'); ?></p></td>
	</tr>
</table>
<map name="map_webpal">
