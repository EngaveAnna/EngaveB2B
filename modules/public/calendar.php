...
$callback = isset ( $_GET ['callback'] ) ? apmgetParam ( $_GET, 'callback', '' ) : 0;
$date = apmgetParam ( $_GET, 'date', null );
$prev_date = apmgetParam ( $_GET, 'uts', null );

// if $date is empty, set to null
$date = $date !== '' ? $date : null;

$this_month = new apm_Utilities_Date ( $date );
...
<?php
$cal = new apm_Output_MonthCalendar ( $this_month );
