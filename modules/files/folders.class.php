 ...
 */
class CFile_Folder extends apm_Core_BaseObject {
	...
	public function getAllowedRecords($uid, $fields = '*', $orderby = 'file_folder_parent, file_folder_name', $unused = null, $unused2 = null, $unused3 = '') {
		$q = $this->_getQuery ();
