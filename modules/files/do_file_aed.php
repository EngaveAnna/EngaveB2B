...
$file_id = ( int ) apmgetParam ( $_POST, 'file_id', 0 );
$isNotNew = ( int ) apmgetParam ( $_POST, 'file_id', '0' );
$cancel = ( int ) apmgetParam ( $_POST, 'cancel', 0 );
$duplicate = ( int ) apmgetParam ( $_POST, 'duplicate', 0 );
$redirect = apmgetParam ( $_POST, 'redirect', 'm=files' );
$notify = apmgetParam ( $_POST, 'notify', '0' );
$notify = ($notify != '0') ? '1' : '0';

$notifyContacts = apmgetParam ( $_POST, 'notify_contacts', 'off' );
...
$obj->file_category = ( int ) apmgetParam ( $_POST, 'file_category', 0 );
$version = apmgetParam ( $_POST, 'file_version', 0 );
$revision_type = apmgetParam ( $_POST, 'revision_type', 0 );
