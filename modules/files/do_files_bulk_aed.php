...
$selected = apmgetParam ( $_POST, 'bulk_selected_file', 0 );
$bulk_file_project = apmgetParam ( $_POST, 'bulk_file_project', 0 );
$bulk_file_folder = apmgetParam ( $_POST, 'bulk_file_folder', 0 );
