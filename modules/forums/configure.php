...
$titleBlock = new apm_Theme_TitleBlock ( 'Configure Forums Module', 'icon.png', $m );
...
<form name="frmForceWatch" method="post" action="?m=forums&a=configure"
	...
	<input type="hidden" name="forcesubmit" value="true" /> <input
		type="checkbox" name="forcewatch" id="forcewatch" value="dod"
		<?php echo $watchAll ? 'checked="checked"' : ''; ?>
		onclick="javascript:submitFrm('frmForceWatch');" /> <label
		for="forcewatch"><?php echo $AppUI->_('forumForceWatch'); ?></label>
</form>