...
<form
	action="?m=tasks&a=addedit&task_project=<?php echo $task_project; ?>"
	method="post" name="otherFrm" accept-charset="utf-8">
	<input type="hidden" name="sub_form" value="1" /> <input type="hidden"
		name="task_id" value="<?php echo $task_id; ?>" /> <input type="hidden"
		name="dosql" value="do_task_aed" /> <input name="hresource_assign"
		type="hidden" value="<?php echo $initResAssignment; ?>" />
		...
		<tr>
			<td valign="top" align="center">
				<table cellspacing="0" cellpadding="2" border="0" class="well">
					...
					<tr>
						<td>
                            <?php echo arraySelect($all_resources, 'resources', 'style="width:220px" size="10" class="form-control" multiple="multiple" ', null); ?>
                        </td>
						<td>
                            <?php echo arraySelect($resources, 'assigned', 'style="width:220px" size="10" class="form-control" multiple="multiple" ', null); ?>
                        </td>
					</tr>
					<tr>
							...
							<table>
								<tr>
									<td align="right"><input type="button"
										class="btn btn-info btn-xs" value="&gt;"
										onclick="addResource(document.otherFrm)" /></td>
									<td>
                                    <?php echo arraySelect($percent, 'resource_assignment', 'size="1" class="form-control"', 100) . '%'; ?>
                                </td>
									<td align="left"><input type="button"
										class="btn btn-info btn-xs" value="&lt;"
										onclick="removeResource(document.otherFrm)" /></td>
								</tr>
							</table>
						</td>
					</tr>
