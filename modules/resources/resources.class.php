 ...
 */
class CResource extends apm_Core_BaseObject {
	...
	public function &loadTypes() {
		trigger_error ( "CResource->loadTypes() has been deprecated in v3.0 and will be removed in v4.0. Please use apmgetSysVal('ResourceTypes') instead.", E_USER_NOTICE );
	...
	public function typeSelect() {
		trigger_error ( "CResource->typeSelect() has been deprecated in v3.0 and will be removed in v4.0. Please use apmgetSysVal('ResourceTypes') instead.", E_USER_NOTICE );
		
		$typelist = apmgetSysVal ( 'ResourceTypes' );
		if (! count ( $typelist )) {
			include apm_BASE_DIR . '/modules/resources/setup.php';
			$setup = new SResource ();
			$setup->upgrade ( '1.0.1' );
			$typelist = apmgetSysVal ( 'ResourceTypes' );
		}
	...
	public function getTypeName() {
		trigger_error ( "CResource->getTypeName() has been deprecated in v3.0 and will be removed in v4.0. Please use apmgetSysVal('ResourceTypes') instead.", E_USER_NOTICE );
