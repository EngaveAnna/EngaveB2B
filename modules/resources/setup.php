...
$config ['mod_directory'] = 'resources'; // tell apmProject where to find this module
$config ['mod_setup_class'] = 'CSetupResources'; // the name of the PHP setup class (used below)
$config ['mod_type'] = 'user'; // 'core' for modules distributed with apm by standard, 'user' for additional modules
 ...
 */
class CSetupResources extends apm_System_Setup {
