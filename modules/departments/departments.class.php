 ...
 */
class CDepartment extends apm_Core_BaseObject {
	/**
	 *
	...
	/**
	 * This is a nasty hack because our property names don't follow our naming conventions.
	 * This is legacy
	 ...
	 *        	int User id number
	 * @param
	 *        	string Optional fields to be returned by the query, default is all
	 * @param
	 *        	string Optional sort order for the query
	 * @param
	 *        	string Optional name of field to index the returned array
	 * @param
	 *        	array Optional array of additional sql parameters (from and where supported)
	 * @return array
	 */
	...
	protected function hook_preStore() {
		...
		$this->dept_url = str_replace ( array (
				'"',
				'"',
				'<',
				'>' 
