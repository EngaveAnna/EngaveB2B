 ...
 */
class CCompany extends apm_Core_BaseObject {
	/**
	 *
	 * @var int Primary Key
	 */
	...
	public $company_tin = null;
	public $company_paymentid = null;
	public $company_paymentkey = null;
	/**
	 *
	 * @var string
	 */
	...
	public function canDelete($notUsed = null, $notUsed2 = null, $notUsed3 = null) {
		$tables [] = array (
				...
				'name' => 'projects',
				'idfield' => 'project_id',
				'joinfield' => 'project_company' 
		);
		$tables [] = array (
				'label' => 'Departments',
				'name' => 'departments',
				'idfield' => 'dept_id',
				'joinfield' => 'dept_company' 
		);
		$tables [] = array (
				'label' => 'Users',
				'name' => 'users',
				'idfield' => 'user_id',
				'joinfield' => 'user_company' 
		);
		$tables [] = array (
				'label' => 'Contacts',
				'name' => 'contacts',
				'idfield' => 'contact_id',
				'joinfield' => 'contact_company' 
		);
	...
	protected function hook_preStore() {
		...
		$this->company_primary_url = str_replace ( array (
				'"',
				'"',
				'<',
				'>' 
		), '', $this->company_primary_url );
	...
	public function getCompanyList($notUsed = null, $companyType = -1, $searchString = '', $ownerId = 0, $orderby = 'company_name', $orderdir = 'ASC') {
		...
		$orderby = (property_exists ( $this, $orderby ) || in_array ( $orderby, array (
				'countp',
				'inactive' 
	...
	public function getCompanyPayment($id) {
		...
		$q->addQuery ('company_paymentid, company_paymentkey, company_name');
		$q->addWhere ('company_id='.$id );
		return $q->loadList ();
	}
	 ...
	 * @return Array
	 */
	public function projects(apm_Core_CAppUI $AppUI, $companyId, $active = 1, $sort = 'project_name') {
	 ...
	 *
	 */
	public static function getProjects(apm_Core_CAppUI $AppUI, $companyId, $active = 1, $sort = 'project_name') {
