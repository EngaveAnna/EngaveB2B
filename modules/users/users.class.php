 ...
 */
class CUser extends apm_Core_BaseObject {
	public $user_id = null;
	...
	public function __construct() {
		...
		$this->authenticator = new apm_Authenticators_SQL ();
	}
	...
	protected function hook_postStore() {
		...
		if (! count ( $uprefs ) && $this->user_id > 0) {
			...
			foreach ( $apmrefs as $notUsed => $apmrefsvalue ) {
				$q->addTable ( 'user_preferences', 'up' );
				$q->addInsert ( 'pref_user', $this->user_id );
				$q->addInsert ( 'pref_name', $apmrefsvalue ['pref_name'] );
				$q->addInsert ( 'pref_value', $apmrefsvalue ['pref_value'] );
				$q->exec ();
				$q->clear ();
			}
		}
	...
	public function canCreate() {
		...
		if (parent::canCreate () || ($this->externally_created_user && 'true' == apmgetConfig ( 'activate_external_user_creation', 'false' ))) {
			return true;
		}
	...
	public function canDelete($notUsed = null, $notUsed2 = null, $notUsed3 = null) {
		$tables [] = array (
				...
				'name' => 'companies',
				'idfield' => 'company_id',
				'joinfield' => 'company_owner' 
		);
		$tables [] = array (
				'label' => 'Department Owner',
				'name' => 'departments',
				'idfield' => 'dept_id',
				'joinfield' => 'dept_owner' 
		);
		$tables [] = array (
				'label' => 'Project Owner',
				'name' => 'projects',
				'idfield' => 'project_id',
				'joinfield' => 'project_owner' 
		);
		$tables [] = array (
				'label' => 'Project Creator',
				'name' => 'projects',
				'idfield' => 'project_id',
				'joinfield' => 'project_creator' 
		);
		$tables [] = array (
				'label' => 'Project Updator',
				'name' => 'projects',
				'idfield' => 'project_id',
				'joinfield' => 'project_updator' 
		);
		$tables [] = array (
				'label' => 'Task Owner',
				'name' => 'tasks',
				'idfield' => 'task_id',
				'joinfield' => 'task_owner' 
		);
		$tables [] = array (
				'label' => 'Task Creator',
				'name' => 'tasks',
				'idfield' => 'task_id',
				'joinfield' => 'task_creator' 
		);
		$tables [] = array (
				'label' => 'Task Updator',
				'name' => 'tasks',
				'idfield' => 'task_id',
				'joinfield' => 'task_updator' 
		);
		$tables [] = array (
				'label' => 'Task Assignee',
				'name' => 'user_tasks',
		...
		$tables [] = array (
				...
				'name' => 'files',
				'idfield' => 'file_id',
				'joinfield' => 'file_owner' 
		);
		$tables [] = array (
				'label' => 'Forum Owner',
				'name' => 'forums',
				'idfield' => 'forum_id',
				'joinfield' => 'forum_owner' 
		);
		$tables [] = array (
				'label' => 'Forum Moderator',
				'name' => 'forums',
				'idfield' => 'forum_id',
				'joinfield' => 'forum_moderated' 
		);
		$tables [] = array (
				'label' => 'Forum Message Author',
				'name' => 'forum_messages',
				'idfield' => 'message_id',
				'joinfield' => 'message_author' 
		);
		$tables [] = array (
				'label' => 'Forum Message Editor',
				'name' => 'forum_messages',
				'idfield' => 'message_id',
				'joinfield' => 'message_editor' 
		);
		$tables [] = array (
				'label' => 'Link Owner',
				'name' => 'links',
				'idfield' => 'link_id',
				'joinfield' => 'link_owner' 
		);
	...
	/**
	 * * Function that checks if a user is active or not (i.e.
	 * are they able to login to the system)
	 * 
	 * @param
	 *        	$userId
	 * @return mixed
