...
class apm_System_Dispatcher {
	 ...
	 * @return Dispatcher
	 */
	public function subscribe(apm_Interfaces_Listener $listener, $resourceName = '*', $event = '*') {
	 ...
	 * @return Dispatcher
	 */
	public function unsubscribe(apm_Interfaces_Listener $listener, $resourceName = '*', $event = '*') {
