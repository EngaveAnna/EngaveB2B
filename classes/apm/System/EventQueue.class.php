 ...
 *
 * @todo    This can probably be converted to extend the apm_Core_BaseObject and just get rid of a bunch of this code. ~ dkc 28 Oct 2012
 */
class apm_System_EventQueue {
	 ...
	 *        	function to call when this event is due.
	 * @param mixed $args
	 *        	Arguments to pass to the callback
	 * @param string $module
	 *        	module, or originator of the event
	 * @param string $type
	 *        	type of event (to allow searching)
	 * @param integer $id
	 *        	id of originating event.
	 * @param integer $date
	 *        	Seconds since 1970 to trigger event.
	 * @param integer $repeat_interval
	 *        	seconds to repeat
