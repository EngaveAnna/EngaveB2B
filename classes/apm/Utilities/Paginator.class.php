...
/**
 * This class takes an array of items and allows us to paginate over them.
 * This
...
class apm_Utilities_Paginator {
	...
	public function __construct(array $items) {
		...
		$this->_pagesize = apmgetConfig ( 'page_size', $this->_pagesize );
	}
	
	/**
	 * This method goes to the specified $page and gives you the next $pagesize
	 * items in an array.
	 * This keeps the original indexes intact so you can
	 ...
	 *
	 * @param apm_Coretype_CAppUI $AppUI        	
	 * @param string $m        	
	 * @param int $tab        	
	 * @param array $params        	
	 * @return string
