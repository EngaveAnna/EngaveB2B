...
class apm_Controllers_View {
	...
	protected $key = '';
	protected $fields = '';
	public function __construct(apm_Core_CAppUI $AppUI, apm_Core_BaseObject $object, $noun) {
		$this->AppUI = $AppUI;
		$this->object = $object;
		$this->noun = $noun;
		
		$this->action = '?m=' . apm_pluralize ( strtolower ( $noun ) );
