 ...
 */
class apm_Output_PDFRenderer {
	protected $pdf = null;
	protected $font_dir = '';
	protected $temp_dir = '';
	public function __construct($papersize = 'A4', $orientation = 'portrait') {
		$this->font_dir = apm_BASE_DIR . '/lib/ezpdf/fonts';
		$this->temp_dir = apm_BASE_DIR . '/files/temp';
	...
	public function addDate($dateformat) {
		...
		$this->pdf->ezText ( $date->format ( $dateformat ), 8, array (
				'justification' => 'right',
				'width' => 45 
		) );
	}
	...
	public function addText($text, $size = 0, $options = array(), $test = 0) {
