...
/**
 * A simple iCal creator for apmProject.
 *
...
class apm_Output_iCalendar {
	...
	public static function formatCalendarItem($calendarItem, $module_name) {
		...
		if ($calendarItem ['project_id']) {
			...
			$attachments .= 'ATTACH;VALUE=URL:' . apm_BASE_URL . '/index.php?m=projects&a=view&project_id=' . $calendarItem ['project_id'] . "\r\n";
		}
		$description .= '\r\n----------------------------------------\r\n';
