 ...
 * @deprecated
 */
class apm_Authenticators_PostNuke extends apm_Authenticators_Base {
	public function __construct() {
		parent::__construct ();
		
		$this->fallback = isset ( $apmconfig ['postnuke_allow_login'] ) ? $apmconfig ['postnuke_allow_login'] : false;
		
		trigger_error ( "apm_Authenticators_PostNuke has been deprecated in v3.0 and will be removed by v4.0. There is no replacement as PostNuke is a dead project.", E_USER_NOTICE );
	}
