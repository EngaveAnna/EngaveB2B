	...
	var methods = {
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
							  ...
							  'styles'	: { "select":true,
											"default": lang['Formatting'],
											"tooltip": lang['Paragraph Format'],
											"commandname": "formatBlock",
												"custom":null },

							 'font_size': {	"select":true,
											"default": lang['Font size'],
			...
			var statusBar = $("<div/>", {	id : "statusbar",
	       	...
	       	if(settings['status_bar']){
				editor.keyup(function(event){
					...
					$(editor_Content).data("statusBar").html('<div class="label">'+lang['Words']+' : '+wordCount+'</div>');
					$(editor_Content).data("statusBar").append('<div class="label">'+lang['Characters']+' : '+charCount+'</div>');
            	});
	        }	        
