...
DEFINE ( 'MAX_GANTTIMG_SIZE_H', 20000 );
...
DEFINE ( "HOURSTYLE_EMPTY", 5 ); // Don't show any hour, just for showing the lines
...
DEFINE ( "DAYSTYLE_LONGDAYDATE1US", 13 ); // "Monday Jun 23"
DEFINE ( "DAYSTYLE_LONGDAYDATE2US", 14 ); // "Monday Jun 23 2003"
DEFINE ( "DAYSTYLE_SHORTDAYDATE1US", 15 ); // "Mon 6/23"
DEFINE ( "DAYSTYLE_SHORTDAYDATE2US", 16 ); // "Mon Jun 23"
DEFINE ( "DAYSTYLE_SHORTDAYDATE3US", 17 ); // "Mon Jun 23"
DEFINE ( "DAYSTYLE_SHORTDATE1US", 18 ); // "6/23"
DEFINE ( "DAYSTYLE_SHORTDATE2US", 19 ); // "Jun 23"
			...
			if ($this->scale->IsDisplayDay ()) {
				...
				switch ($this->scale->day->iStyle) {
					...
					case DAYSTYLE_LONGDAYDATE2 :
						...
						break;
					case DAYSTYLE_LONGDAYDATE1US :
						$txt = "Monday Jun 23";
						break;
					case DAYSTYLE_LONGDAYDATE2US :
						$txt = "Monday Jun 23 2003";
						break;
					case DAYSTYLE_SHORT :
						$txt = "Mon";
						break;
					...
					case DAYSTYLE_SHORTDAYDATE2 :
						$txt = "Mon 23 Jun";
						break;
					case DAYSTYLE_SHORTDAYDATE1US :
						$txt = "Mon 6/23";
						break;
					case DAYSTYLE_SHORTDAYDATE2US :
						$txt = "Mon Jun/23";
						break;
					...
					case DAYSTYLE_SHORTDATE2 :
						$txt = "23 Jun";
						break;
					case DAYSTYLE_SHORTDATE1US :
						$txt = "6/23";
						break;
					case DAYSTYLE_SHORTDATE2US :
						$txt = "Jun 23";
						break;
		...
		if ($this->day->iShowLabels) {
			...
			for($i = 0; $i < $this->GetNumberOfDays (); ++ $i, $x += $daywidth, $day += 1, $day %= 7) {
				...
				switch ($this->day->iStyle) {
					...
					case DAYSTYLE_SHORTDAYDATE1US :
						// "Mon 6/23"
						$txt = strftime ( '%a ' . $mn . '/%d', $datestamp );
						break;
					case DAYSTYLE_SHORTDAYDATE2US :
						// "Mon Jun 23"
						$txt = strftime ( '%a %b %d', $datestamp );
						break;
					case DAYSTYLE_SHORTDAYDATE3US :
						// "Mon Jun 23 2003"
						$txt = strftime ( '%a %b %d %Y', $datestamp );
						break;
					case DAYSTYLE_LONGDAYDATE1 :
						// "Monday 23 Jun"
						$txt = strftime ( '%A %d %b', $datestamp );
					...
					case DAYSTYLE_SHORTDATE1US :
						// "6/23"
						$txt = strftime ( $mn . '/%d', $datestamp );
						break;
					case DAYSTYLE_SHORTDATE2US :
						// "Jun 23"
						$txt = strftime ( '%b %d', $datestamp );
						break;
					case DAYSTYLE_SHORTDATE3 :
						// "Mon 23"
