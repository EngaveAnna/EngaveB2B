...
<body>
	<form method='get' action='parser.php'>
		<table border='1' cellpadding='5' cellspacing='0'>
			<tr>
				<td valign='top'>input:<br /> <textarea cols='45' rows='10'
						name='string'><?php echo @$_GET['string']?></textarea><br />
				
				<td valign='top'>ouput:<br /> <textarea cols='45' rows='10'><?php echo htmlentities($parsed, ENT_QUOTES)?></textarea><br />
...
<?php echo $parsed?>
			...
			<tr>
				<td colspan='2'>possible codes: <pre>
[b]bold[/b]
[i]italic[/i]
[u]underline[/u]
[s]strike[/s]
