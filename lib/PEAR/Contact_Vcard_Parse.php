...
// apm apmProject | gregorerhardt 20030914:
...
// apm require_once 'PEAR.php';

// apm class Contact_Vcard_Parse extends PEAR {
class Contact_Vcard_Parse {
	 ...
	 *        	The filename to read for vCard information.
	 *        	
	 ...
	 *        
	 * @param array $text
	 *        	A block of text to read for vCard information.
	 *        	
	 ...
	 *        
	 * @param string $text
	 *        	The string on which to convert line endings.
	 *        	
	 * @return void
	 *
	 */
	 ...
	 *        	If splitting the string results in a
	 ...
	 *        
	 * @param array $source
	 *        	An array of lines to be read for vCard
	 *        	information.
	 *        	
	 * @return array An array of of vCard information extracted from the
	 *         source array.
	 ...
	 *        
	 * @param string $text
	 *        	A left-part (before-the-colon part) from a
	 *        	vCard line.
	 *        	
	 ...
	 *        
	 * @param array $params
	 *        	A parameter array from a vCard line.
	 *        	
	 * @param string $text
	 *        	A right-part (after-the-colon part) from a
	 *        	vCard line.
	 *        	
	 * @return void
	 *
	 ...
	 *        
	 * @param string $value
	 *        	The first element in a parameter name-value
	 *        	pair.
	 *        	
	 ...
	 *        
	 * @param string $text
	 *        	The right-part (after-the-colon part) of a
	 *        	vCard line.
	 *        	
