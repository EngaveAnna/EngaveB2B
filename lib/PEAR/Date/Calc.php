...
class Date_Calc {
	 ...
	 *
	 * @param
	 *        	string the strftime() format to return the date
	 *        	
	 * @access public
	 *        
	 ...
	 *
	 * @param
	 *        	string year in format CCYY
	 * @param
	 *        	string month in format MM
	 * @param
	 *        	string day in format DD
	 *        	
	 * @access public
	 *        
	 ...
	 *
	 * @param
	 *        	string year in format CCYY, default is current local year
	 * @param
	 *        	string month in format MM, default is current local month
	 * @param
	 *        	string day in format DD, default is current local day
	 *        	
	 * @access public
	 *        
	...
	function weekOfYear($day, $month, $year) {
		...
		$week_year = $year - 1501;
		$week_day = $week_year * 365 + floor ( $week_year / 4 ) - 29872 + 1 - floor ( $week_year / 100 ) + floor ( ($week_year - 300) / 400 );
		
		$week_number = ceil ( (Date_Calc::julianDate ( $day, $month, $year ) + floor ( ($week_day + 4) % 7 )) / 7 );
	 ...
	 *
	 * @param
	 *        	string year in format CCYY, default current local year
	 * @param
	 *        	string month in format MM, default current local month
	 * @param
	 *        	string day in format DD, default current local day
	 *        	
	 * @access public
	 *        
	 ...
	 *        	string day in format DD, default current local day
	 * @param
	 *        	string format for returned date
	 *        	
	 * @access public
	 *        
	 ...
	 *        	string day in format DD, default current local day
	 * @param
	 *        	boolean onOrAfter if true and days are same, returns current day
	 * @param
	 *        	string format for returned date
	 *        	
	 * @access public
	 ...
	 *        	string day in format DD, default current local day
	 * @param
	 *        	boolean onOrBefore if true and days are same, returns current day
	 * @param
	 *        	string format for returned date
	 *        	
	 * @access public
	 ...
	 *        	string month in format MM, default current local month
	 * @param
	 *        	string year in format YYCC, default current local year
	 *        	
	 * @access public
	 *        
	 ...
	 *
	 * @param
	 *        	string year in format CCYY, default to current local year
	 * @param
	 *        	string month in format MM, default to current local month
	 *        	
	 * @access public
	 *        
	...
	function endOfWeek($day = "", $month = "", $year = "", $format = "%Y%m%d", $fdow = null) {
		...
		$last_dayOfWeek = (Date_Calc::dateToDays ( $day, $month, $year ) + (6 - $this_weekday + $fdow));
	...
	function beginOfNextWeek($day = "", $month = "", $year = "", $format = "%Y%m%d", $fdow = null) {
		...
		$beginOfWeek = (Date_Calc::dateToDays ( $next_week_day, $next_week_month, $next_week_year ) - ($this_weekday - $fdow));
	 ...
	 *
	 * @param
	 *        	string occurance: 1=first, 2=second, 3=third, etc.
	 * @param
	 *        	string dayOfWeek: 0=Sunday, 1=Monday, etc.
	 * @param
	 *        	string year in format CCYY
	 * @param
	 *        	string month in format MM
	 ...
	 * strfmt().
	 * This function is used to alleviate the
	 ...
	 *        	string month in format MM
	 * @param
	 *        	int optional length of abbreviation, default is 3
	 *        	
	 * @access public
	 *        
