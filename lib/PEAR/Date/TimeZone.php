...
class Date_TimeZone {
	...
	/**
	 * Returns the time zone id for this time zone, i.e.
	 * "America/Chicago"
	 *
	 * @access public
	...
	/**
	 * Returns the short name for this time zone, i.e.
	 * "CST"
	 *
	 * @access public
	...
	/**
	 * Returns the DST long name for this time zone, i.e.
	...
	/**
	 * Returns the DST short name for this time zone, i.e.
	 * "CDT"
	 *
	 * @access public
...
if (isset ( $_DATE_TIMEZONE_DEFAULT ) && Date_TimeZone::isValidID ( $_DATE_TIMEZONE_DEFAULT )) {
	$result = Date_TimeZone::setDefault ( $_DATE_TIMEZONE_DEFAULT );
} elseif (getenv ( 'PHP_TZ' ) && Date_TimeZone::isValidID ( getenv ( 'PHP_TZ' ) )) {
	$result = Date_TimeZone::setDefault ( getenv ( 'PHP_TZ' ) );
} elseif (getenv ( 'TZ' ) && Date_TimeZone::isValidID ( getenv ( 'TZ' ) )) {
	$result = Date_TimeZone::setDefault ( getenv ( 'TZ' ) );
} elseif ($res = Date_TimeZone::isValidID ( date ( 'T' ) )) {
	$result = Date_TimeZone::setDefault ( date ( 'T' ) );
} else {
