 ...
 *
 *    * the specific version of apmProject where the behavior will change; and
 ...
 *
 */
function apmcheckCharset() {
	trigger_error ( "The apmcheckCharset function has been deprecated and will be removed in v4.0.", E_USER_NOTICE );
...
/**
 * This was used to check if a $link was a URL.
 * Since some users use local
 ...
 *
 */
function apm_check_url() {
	trigger_error ( "The apm_check_url function has been deprecated and will be removed in v4.0. There is no replacement.", E_USER_NOTICE );
 ...
 * It was the exact duplciate of the findchild_pr,
...
/**
 * This was a function that simply did a str_repeat..
 * no clue why it didn't
 ...
 * any ancestor.
 * More importantly, it displays the relationship visually
...
/**
 * This was used to display the child departments one row at a time.
 * More
...
function showchilddept_comp(&$a, $level = 0) {
    ...
    <td>
        <a href="./index.php?m=departments&amp;a=addedit&amp;dept_id=' . $a ["dept_id"] . '" title="' . $AppUI->_ ( 'edit' ) . '">
            ' . apmshowImage ( 'icons/stock_edit-16.png', 16, 16, '' ) . '
    </td>
    <td>';
	
	for($y = 0; $y < $level; $y ++) {
		if ($y + 1 == $level) {
			$s .= '<img src="' . apmfindImage ( 'corner-dots.gif' ) . '" width="16" height="12" border="0" alt="">';
		} else {
			$s .= '<img src="' . apmfindImage ( 'shim.gif' ) . '" width="16" height="12" border="0" alt="">';
		}
	}
...
function taskstyle_pd($task) {
	trigger_error ( "The taskstyle_pd function has been deprecated and will be removed in v4.0. Use apmFindTaskComplete() instead.", E_USER_NOTICE );
	
	$style = apmFindTaskComplete ( $task ['task_start_date'], $task ['task_end_date'], $task ['task_percent_complete'] );
 ...
 */
function makePass() {
	trigger_error ( "makePass() has been deprecated in v3.0 and will be removed in v4.0. Use apm_Authenticators_SQL->createNewPassword instead.", E_USER_NOTICE );
...
function buildHeaderNavigation($AppUI, $rootTag = '', $innerTag = '', $dividingToken = '', $m = '') {
	trigger_error ( "The buildHeaderNavigation function has been deprecated in v3.1 and will be removed by v5.0. Please use apm_Theme_Base->buildHeaderNavigation() instead.", E_USER_NOTICE );
 ...
 * @deprecated
 */
function apmgetCleanParam(&$arr, $name, $def = null) {
	trigger_error ( "apmgetCleanParam() has been deprecated in v3.1 and will be removed in v4.0. Use apmgetParam() instead.", E_USER_NOTICE );
	
	return apmgetParam ( $arr, $name, $def );
}
...
function contextHelp($title, $link = '') {
	...
	return apmcontextHelp ( $title, $link );
}
function apmcontextHelp($title, $link = '') {
	global $AppUI;
	trigger_error ( "apmcontextHelp() has been deprecated in v3.1 and will be removed by v5.0", E_USER_NOTICE );
...
function apmgetUsername($username) {
	trigger_error ( "apmgetUsername() has been deprecated in v3.1 and will be removed by v5.0. Please use CContact::getContactByUsername() instead.", E_USER_NOTICE );
	
	return CContact::getContactByUsername ( $username );
}
function apmgetUsernameFromID($userId) {
	trigger_error ( "apmcontextHelp() has been deprecated in v3.1 and will be removed by v5.0. Please use CContact::getContactByUserid() instead.", E_USER_NOTICE );
...
function apmsessionOpen() {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0.", E_USER_NOTICE );
	
	return true;
}
function apmsessionClose() {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0.", E_USER_NOTICE );
	
	return true;
}
function apmsessionRead($id) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_System_Session->read instead.", E_USER_NOTICE );
	
	$session = new apm_System_Session ();
	return $session->read ( $id );
}
function apmsessionWrite($id, $data) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_System_Session->write instead.", E_USER_NOTICE );
	
	$session = new apm_System_Session ();
	return $session->write ( $id, $data );
}
function apmsessionDestroy($id) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_System_Session->destroy instead.", E_USER_NOTICE );
	
	$session = new apm_System_Session ();
	return $session->destroy ( $id );
}
function apmsessionGC() {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_System_Session->gc instead.", E_USER_NOTICE );
	
	$session = new apm_System_Session ();
	return $session->gc ();
}
function apmsessionConvertTime($key) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_System_Session->convertTime instead.", E_USER_NOTICE );
	
	$session = new apm_System_Session ();
	return $session->convertTime ( $key );
}
function apmsessionStart() {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_System_Session->start instead.", E_USER_NOTICE );
	
	$session = new apm_System_Session ();
	return $session->start ();
}
function db_connect($host = 'localhost', $dbname, $user = 'root', $passwd = '', $persist = false) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_connect instead.", E_USER_NOTICE );
...
function db_error() {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_error instead.", E_USER_NOTICE );
...
function db_errno() {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_errno instead.", E_USER_NOTICE );
...
function db_insert_id() {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_insert_id instead.", E_USER_NOTICE );
...
function db_exec($sql) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_exec instead.", E_USER_NOTICE );
	
	global $db, $apm_performance_dbtime, $apm_performance_old_dbqueries;
	
	$connection = new apm_Database_Connection ( $db );
	return $connection->exec ( $sql, $apm_performance_dbtime, $apm_performance_old_dbqueries );
}
function db_free_result($cur) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_free_result instead.", E_USER_NOTICE );
...
function db_num_rows($qid) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_num_rows instead.", E_USER_NOTICE );
...
function db_fetch_row(&$qid) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_fetch_row instead.", E_USER_NOTICE );
...
function db_fetch_assoc(&$qid) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_fetch_assoc instead.", E_USER_NOTICE );
...
function db_fetch_array(&$qid) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_fetch_array instead.", E_USER_NOTICE );
...
function db_fetch_object($qid) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_fetch_object instead.", E_USER_NOTICE );
...
function db_escape($str) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_escape instead.", E_USER_NOTICE );
...
function db_version() {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_version instead.", E_USER_NOTICE );
...
function db_unix2dateTime($time) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_unix2dateTime instead.", E_USER_NOTICE );
...
function db_dateTime2unix($time) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. Please use apm_Database_Connection->db_dateTime2unix instead.", E_USER_NOTICE );
 ...
 * @deprecated
 */
function clash_process(apm_Core_CAppUI $AppUI) {
 ...
 * @deprecated
 */
function clash_mail(apm_Core_CAppUI $AppUI) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. There is no replacement.", E_USER_NOTICE );
 ...
 * @deprecated
 */
function clash_accept(apm_Core_CAppUI $AppUI) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. There is no replacement.", E_USER_NOTICE );
 ...
 * @deprecated
 */
function clash_cancel(apm_Core_CAppUI $AppUI) {
	trigger_error ( __FUNCTION__ . " has been deprecated in v3.2 and will be removed in v5.0. There is no replacement.", E_USER_NOTICE );
