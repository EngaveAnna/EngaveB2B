...
if (! function_exists ( 'mb_str_replace' )) {
	 ...
	 *
	 * @param mixed $search
	 *        	: string or array of strings to be searched.
	 * @param mixed $replace
	 *        	: string or array of the strings that will replace the searched string(s)
	 * @param mixed $subject
...
if (! function_exists ( 'mb_trim' )) {
	 ...
	 *        	string
	 * @param
	 *        	charlist list of characters to remove from the ends of this string.
	 * @param
	 *        	boolean trim the left?
	 * @param
	 *        	boolean trim the right?
	 * @return String
	 */
	function mb_trim($string, $charlist = '\\\\s', $ltrim = true, $rtrim = true) {
		$both_ends = $ltrim && $rtrim;
		
		$char_class_inner = preg_replace ( array (
				'/[\^\-\]\\\]/S',
				'/\\\{4}/S' 
		), array (
				'\\\\\\0',
